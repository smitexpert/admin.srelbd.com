...
$("#add_product").click(function() {
    ...
    if (check != 1) {
        ...
        $("#item_list").append(
            ...
            productName + ' </td> <td style = "text-align:center;" ><input type="number" min="1" max="' +
...
function quantity(event) {
    ...
    $(event.target).closest('tr').find('.quntity_total').append('<input type="hidden" name="quntityTotal[]" value="' +
        total + '">');
