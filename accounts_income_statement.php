...
include('includes/header.php');
	$query = "SELECT * FROM accounts WHERE transaction_type ='credit' ORDER BY money_receipt_no ASC";
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table id="incomeStatement" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center">Payer Name</th>
