...
include('includes/header.php'); 
	$query = "SELECT * FROM debit_item ORDER BY item_name ASC";
...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO debit_item (item_name, entry_by) VALUES ('$item_name', '$created_by')";
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">CREATE DEBIT ITEM
