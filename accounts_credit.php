...
$query_1 = "SELECT money_receipt_no FROM accounts order by id DESC limit 1";
	...
	$money_receipt_no = "AC".$dayMonthYear.$last_serial;
                                                    ...
                                                    <div id="corporate_form_view">
                                                        ...
                                                        <form method="POST" id="accounts_credit">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="">Payer Name:<span class="symbol required"></span></label>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="">Credit From:</label>
                                                                        <!--                                                                        <input type="text" class="form-control" name="description" id="description">-->
                                                                           <select class="form-control" name="description">
                                                                            <option value="">----</option>
                                                                            <option value="idcol" selected>idocl subsidy</option>
                                                                            <option value="bl" selected>Bank Loan</option>
                                                                            <option value="pl" selected>Private Loan</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
