...
include('includes/header.php'); 
	$query = "SELECT * FROM product_name ORDER BY id ASC";
...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO product_name (name, entry_by) VALUES ('$product_name', '$created_by')";
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">ADD NEW PRODUCT NAME
